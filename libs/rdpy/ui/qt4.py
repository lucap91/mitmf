...
from libs.rdpy.protocol.rfb.rfb import RFBClientObserver
from libs.rdpy.protocol.rdp.rdp import RDPClientObserver
from libs.rdpy.core.error import CallPureVirtualFuntion
import sys
