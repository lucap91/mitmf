...
"""
from libs.rdpy.core.layer import LayerAutomata, IStreamSender, Layer
from libs.rdpy.core.type import sizeof, Stream, UInt8, UInt16Le, String
from libs.rdpy.core.error import InvalidExpectedDataException, InvalidValue, InvalidSize, CallPureVirtualFuntion
from libs.rdpy.protocol.rdp.ber import writeLength
import libs.rdpy.core.log as log

import ber, gcc, per
import libs.rdpy.security.rsa_wrapper as rsa
